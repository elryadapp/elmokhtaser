              ...
              InkWell(
                onTap: () {
                  AppUtil.appDialoge(
                      ...
                      .then((value) {
                    authCubit.registerEducationalLevelController.text =
                        value ?? '';
              ...
              InkWell(
                onTap: () {
                  if (authCubit.levelsList.isNotEmpty) {
                    AppUtil.appDialoge(
                            context: context,
                            title: authCubit.registerEducationalLevelController
                                        .text ==
                                    'University_stage'.tr()
                                ? 'University_stage'.tr()
                                : 'select_your_level'.tr(),
                            content:
                    ...
                    onTap: () {
                      if (state.changetermsState &&
                        ...
                        if (authCubit.registerEducationalLevelController.text ==
                            '') {
                          AppUtil.flushbarNotification('level_error'.tr());
                        } else if (authCubit.registerLevelController.text ==
                            '') {
                          AppUtil.flushbarNotification('level_year'.tr());
                        } else {
                          AppUtil.flushbarNotification('terms_error'.tr());
                        }
                      }
                    })
            ],
